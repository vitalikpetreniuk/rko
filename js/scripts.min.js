	...
	$('.modal-body-scroll').mCustomScrollbar({
        ...
        callbacks:{
            whileScrolling: function(){
                scrollOffsetLeft = $(this).find('.mCSB_container').css('left');
                scrollOffsetLeft = parseInt(scrollOffsetLeft.replace('px','').replace('-',''));
                if(scrollOffsetLeft >= 32){
                    $('.table-col-first').addClass('absolute').css('left', scrollOffsetLeft);
                    $('.table-col-second').each(function () {
                        var colFirstWidth = $(this).siblings('.table-col-first').outerWidth();
                        var colSecondWidth = $(this).outerWidth();
                       $(this).addClass('absolute').css('left', colFirstWidth+scrollOffsetLeft);
                       $(this).closest('.table-row').css('padding-left', colFirstWidth+colSecondWidth+32);
                    });
                }else{
                    $('.table-col-first, .table-col-second').removeClass('absolute').closest('.table-row').removeAttr('style')
                }
            }
        }
    });

	$('.table-item .remove').on('click', function () {
